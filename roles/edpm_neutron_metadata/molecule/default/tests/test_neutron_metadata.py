...
HAPROXY_CONFIG_DIR = "/var/lib/neutron/ovn-metadata-proxy"
EDPM_OVN_METADATA_AGENT_SERVICE = "edpm_ovn_metadata_agent.service"
OVN_METADATA_AGENT_CONTAINER = "ovn_metadata_agent"
HAPROXY_CONFIG = """
global
...
class TestNeutronMetadata(unittest.TestCase):
    ...
    def test_sidecar_container_wrapper_script_was_created(self):
        assert self.host.file(
            "/var/lib/neutron/ovn_metadata_haproxy_wrapper").exists
