...
CONTAINER_PUPPET_CONFIG = '/var/lib/edpm-config/container-puppet-config'
...
class ContainerPuppetManager:
    ...
    edpm-container-manage role that is using podman_container module.
    """
    ...
    def _get_config(self, data):
        ...
        default_data = {
            ...
            # https://bugs.launchpad.net/edpm/+bug/1864501
