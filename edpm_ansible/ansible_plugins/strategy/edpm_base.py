...
DOCUMENTATION = '''
    strategy: edpm_base
    short_description: Base edpm strategy shared with linear & free
    description:
    version_added: "2.9"
...
class EdpmBase(StrategyBase):

    def __init__(self, *args, **kwargs):
        super(EdpmBase, self).__init__(*args, **kwargs)
    ...
    def _get_fail_percent(self, host):
        ...
        role = fail_vars.get('edpm_role_name', 'default')
