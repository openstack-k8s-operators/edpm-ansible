...
class FilterModule(object):
    ...
    def tht_abspath(self, file_paths, ignore_error=False,
                    root_dir='/usr/share/openstack-edpm-heat-templates'):
    ...
    def get_filtered_role_resources(service_chain_resources,
        ...
        :param edpm_resources: Dictionary of edpm resources
        :type edpm_resources: Dictionary

        :returns: Dictionary
        """
        role_services = dict()
        for resource_id in service_chain_resources:
            if resource_id in edpm_resources.keys():
                role_services[resource_id] = edpm_resources[resource_id]
        else:
